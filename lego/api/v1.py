...
router.register(
    r"meeting-token", MeetingInvitationTokenViewSet, base_name="meeting-token"
)
...
router.register(
    r"membership-history", MembershipHistoryViewSet, base_name="membership-history"
)
router.register(
...
router.register(
    r"oauth2-access-tokens", AccessTokenViewSet, base_name="oauth2-access-tokens"
)
router.register(
